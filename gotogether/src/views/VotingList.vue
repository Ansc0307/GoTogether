...
const mockActiveVotings = [
	...
	{ id: 'mock-a2', title: '¿Qué tipo de alojamiento preferimos?', options: ['Hostal','Hotel','Airbnb'], voters: ['Carlos'], image:'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=800&auto=format&fit=crop', deadline: new Date(Date.now() + 3*24*60*60*1000) }
]
...
const goToCreateVoting = () => router.push('/voting/create')
</script>
